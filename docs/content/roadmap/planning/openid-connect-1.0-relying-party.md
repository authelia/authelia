...
description: "The Authelia roadmap item for the OpenID Connect 1.0 Relying Party role allowing delegation of authentication to external identity providers."
