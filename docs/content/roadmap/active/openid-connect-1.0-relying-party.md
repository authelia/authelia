...
See the [configuration documentation](../../configuration/first-factor/external-identity.md) for how to configure it.
...
which are stored in the `user_external_identity_links` table. Neither the `email` claim nor the `preferred_username` claim
...
See the
[FAQ](../../integration/openid-connect/frequently-asked-questions.md#how-should-i-link-user-accounts-to-authelia-openid-connect-10-responses-in-the-application-im-designing)
