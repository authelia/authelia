---
title: "docs/content/en/reference/cli/authelia/authelia storage user webauthn export"
description: "Reference for the docs/content/en/reference/cli/authelia/authelia storage user webauthn export command."
lead: ""
