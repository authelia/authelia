---
title: "docs/content/en/reference/cli/authelia/authelia storage user webauthn delete"
description: "Reference for the docs/content/en/reference/cli/authelia/authelia storage user webauthn delete command."
lead: ""
