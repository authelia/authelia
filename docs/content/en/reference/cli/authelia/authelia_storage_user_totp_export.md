---
title: "docs/content/en/reference/cli/authelia/authelia storage user totp export"
description: "Reference for the docs/content/en/reference/cli/authelia/authelia storage user totp export command."
lead: ""
