---
title: "docs/content/en/reference/cli/authelia/authelia storage user identifiers add"
description: "Reference for the docs/content/en/reference/cli/authelia/authelia storage user identifiers add command."
lead: ""
