...
```
  ...
  -X, --exclude strings                                            Sets the names of excluded generators
      ...
      --file.docs.static.json-schemas.exports.identifiers string   Sets the path of the identifiers export JSONSchema (default "exports.identifiers.json")
      --file.docs.static.json-schemas.exports.totp string          Sets the path of the TOTP export JSONSchema (default "exports.totp.json")
      --file.docs.static.json-schemas.exports.webauthn string      Sets the path of the WebAuthn export JSONSchema (default "exports.webauthn.json")
