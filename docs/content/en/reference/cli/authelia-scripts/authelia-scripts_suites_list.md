---
title: "docs/content/en/reference/cli/authelia-scripts/authelia-scripts suites list"
description: "Reference for the docs/content/en/reference/cli/authelia-scripts/authelia-scripts suites list command."
lead: ""
