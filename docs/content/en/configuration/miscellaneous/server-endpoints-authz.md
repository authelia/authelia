...
The underlying implementation for the endpoint. Valid case-sensitive values are `ForwardAuth`, `AuthRequest`, and
`Legacy`. Read more about the implementations in the
