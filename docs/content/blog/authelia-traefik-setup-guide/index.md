...
description: "A setup guide for configuring Authelia with the Traefik reverse proxy providing an opinionated and fully supported deployment approach for administrators."
