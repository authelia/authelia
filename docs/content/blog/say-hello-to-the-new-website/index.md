...
description: "Introducing the new Authelia website which combines the main landing site and documentation into one unified package using the Hugo Doks theme and layout."
