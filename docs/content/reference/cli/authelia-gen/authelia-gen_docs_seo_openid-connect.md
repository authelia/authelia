---
title: "authelia-gen docs seo openid-connect"
description: "Reference for the authelia-gen docs seo openid-connect command."
lead: ""
...
## authelia-gen docs seo openid-connect

Generate doc openid connect integration guide seo tags

```
authelia-gen docs seo openid-connect [flags]
```

### Options

```
  -h, --help   help for openid-connect
```
