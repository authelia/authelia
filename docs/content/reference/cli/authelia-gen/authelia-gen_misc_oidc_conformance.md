...
## authelia-gen misc oidc conformance

Generate OpenID Connect 1.0 conformance configurations
...
```
  ...
  -h, --help                  help for conformance
      ...
      --suites strings        names of the plans to generate
      --token string          conformance api token
      --url string            conformance suite url for conformance plans (default "https://conformance.example.com")
