---
title: "authelia storage known-ips list"
description: "Reference for the authelia storage known-ips list command."
lead: ""
...
## authelia storage known-ips list
...
```
authelia storage known-ips list [username] [flags]
```
...
```
      --format string   The format to display the known IP addresses in, valid values are: table, json (default "table")
