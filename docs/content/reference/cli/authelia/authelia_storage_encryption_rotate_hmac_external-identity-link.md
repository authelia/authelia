---
title: "authelia storage encryption rotate hmac external-identity-link"
description: "Reference for the authelia storage encryption rotate hmac external-identity-link command."
lead: ""
date: 2026-09-13T17:00:52+10:00
draft: false
images: []
weight: 905
toc: true
...
## authelia storage encryption rotate hmac external-identity-link

Rotate the external identity link HMAC key
...
```
authelia storage encryption rotate hmac external-identity-link [flags]
```

### Examples

```
authelia storage encryption rotate hmac external-identity-link --config config.yml
...
```
  ...
  -h, --help    help for external-identity-link
```
