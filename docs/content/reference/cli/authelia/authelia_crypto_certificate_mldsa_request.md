---
title: "authelia crypto certificate mldsa request"
description: "Reference for the authelia crypto certificate mldsa request command."
lead: ""
...
## authelia crypto certificate mldsa request

Generate an ML-DSA private key and certificate signing request

### Synopsis

Generate an ML-DSA private key and certificate signing request.

This subcommand allows generating an ML-DSA private key and certificate signing request.

```
authelia crypto certificate mldsa request [flags]
```

### Examples

```
authelia crypto certificate mldsa request --help
```
