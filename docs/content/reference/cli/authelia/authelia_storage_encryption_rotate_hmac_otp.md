---
title: "authelia storage encryption rotate hmac otp"
description: "Reference for the authelia storage encryption rotate hmac otp command."
lead: ""
...
## authelia storage encryption rotate hmac otp

Rotate the OTP HMAC key
...
```
authelia storage encryption rotate hmac otp [flags]
```

### Examples

```
authelia storage encryption rotate hmac otp --config config.yml
