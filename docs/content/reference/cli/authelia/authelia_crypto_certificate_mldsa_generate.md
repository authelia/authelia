...
## authelia crypto certificate mldsa generate

Generate an ML-DSA private key and certificate

### Synopsis

Generate an ML-DSA private key and certificate.

This subcommand allows generating an ML-DSA private key and certificate.
