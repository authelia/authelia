...
description: "A reference guide on supported cache integrations for Authelia including Redis Standalone and Redis Sentinel version support and known limitations."
