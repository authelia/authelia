...
description: "A reference guide on validating that the Authelia forwarded authentication proxy integration is operating correctly using browser developer tools and analysis."
