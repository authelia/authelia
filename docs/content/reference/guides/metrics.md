---
title: "Telemetry"
description: "A reference guide on the Authelia telemetry and metrics system including Prometheus integration, recorded metrics for authentication, authorization, and more."
