...
description: "An architecture decision record on how Authelia handles OpenID Connect 1.0 client authorization policies and why access control rules are incompatible."
