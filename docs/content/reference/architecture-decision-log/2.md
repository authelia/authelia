...
description: "An architecture decision record on the limitations of configuring Authelia via environment variables and secrets for complex object and list types."
