...
[OpenID Connect 1.0] Provider like GitLab, Discord, or GitHub. This section contains guides for integrating
...
```text
https://{{< sitevar name="subdomain-authelia" nojs="auth" >}}.{{< sitevar name="domain" nojs="example.com" >}}/api/identity/<id>/callback
```
