---
title: "Get started"
description: "A getting started guide for Authelia covering prerequisites, important deployment requirements, links to essential configuration sections, and initial setup."
