---
title: "Chart"
description: "A guide to using the Authelia Helm chart to integrate Authelia with Kubernetes including repository setup, values configuration, and important notes."
