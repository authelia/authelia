...
description: "A guide to integrating Authelia with the Traefik Kubernetes Ingress controller including both Kubernetes Ingress and Traefik CRD configurations."
