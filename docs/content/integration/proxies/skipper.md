---
title: "Skipper"
description: "An integration guide for Authelia and the Skipper reverse proxy which is likely supported but currently under construction and seeking contributors."
