...
[Skipper] is probably supported by **Authelia**.
...
It's currently not certain, but fairly likely that [Skipper] is supported by **Authelia**. We wish to add documentation
