---
title: "NGINX"
description: "An integration guide for Authelia and the NGINX reverse proxy including the auth_request module configuration examples, deployment considerations, and caveats."
