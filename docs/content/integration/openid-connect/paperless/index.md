  ...
  oidc:
    ...
    clients:
      - client_id: 'paperless'
        ...
        redirect_uris:
          - 'https://paperless.{{< sitevar name="domain" >}}/accounts/authelia/login/callback'
        scopes:
          - 'openid'
          - 'profile'
          - 'email'
...
PAPERLESS_SOCIALACCOUNT_PROVIDERS={"openid_connect":{"SCOPE":["openid","profile","email"],"OAUTH_PKCE_ENABLED":true,"APPS":[{"provider_id":"authelia","name":"Authelia","client_id":"paperless","secret":"insecure_secret","settings":{"server_url":"https://{{< sitevar name="subdomain-authelia" >}}.{{< sitevar name="domain" >}}","token_auth_method":"client_secret_basic"}}]}}
```
    ...
    "APPS": [
      {
        ...
        "settings": {
          "server_url": "https://{{< sitevar name="subdomain-authelia" >}}.{{< sitevar name="domain" >}}",
