---
title: "Chronograf"
description: "A guide on integrating Chronograf with the Authelia OpenID Connect 1.0 Provider for single sign-on (SSO) with configuration examples and available options."
summary: ""
...
- **Application Root URL:** `https://chronograf.{{< sitevar name="domain" nojs="example.com" >}}/`
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [Chronograf] which will
