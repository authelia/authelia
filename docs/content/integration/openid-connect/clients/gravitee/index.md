...
- **Application Root URL:** `https://gravitee.{{< sitevar name="domain" nojs="example.com" >}}/`
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [Gravitee] which will
