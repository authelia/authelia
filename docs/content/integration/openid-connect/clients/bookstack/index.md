---
title: "BookStack"
description: "A guide on integrating BookStack with the Authelia OpenID Connect 1.0 Provider for single sign-on (SSO) with configuration examples and available options."
summary: ""
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [BookStack] which will
