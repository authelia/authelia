...
- **Client ID:** `openid-connect-playground`
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [OpenID Connect Playground] which will
