...
description: "A guide on integrating Ansible AWX and Ansible Tower with the Authelia OpenID Connect 1.0 Provider for single sign-on (SSO) with configuration examples."
summary: ""
...
- **Application Root URL:** `https://awx.{{< sitevar name="domain" nojs="example.com" >}}/`
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [Ansible AWX] which will
