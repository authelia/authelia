---
title: "Paperless"
description: "A guide on integrating Paperless with the Authelia OpenID Connect 1.0 Provider with configuration examples and an outline of the available options for SSO."
summary: ""
...
- [Paperless]
  - [v3.0.5](https://github.com/paperless-ngx/paperless-ngx/releases/tag/v3.0.5)
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [Paperless] which will
