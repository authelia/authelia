---
title: "Komga"
description: "A guide on integrating Komga with the Authelia OpenID Connect 1.0 Provider including example configurations and an overview of available options for SSO."
summary: ""
...
- **Application Root URL:** `https://komga.{{< sitevar name="domain" nojs="example.com" >}}/`
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [Komga] which will
