...
- **Application Root URL:** `https://rustdesk.{{< sitevar name="domain" nojs="example.com" >}}/`
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [RustDesk Server Pro] which will
