---
title: "Tandoor"
description: "A guide on integrating Tandoor with the Authelia OpenID Connect 1.0 Provider with configuration examples and an outline of the available options for SSO."
summary: ""
...
- **Application Root URL:** `https://tandoor.{{< sitevar name="domain" nojs="example.com" >}}/`
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [Tandoor] which will
