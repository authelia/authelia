---
title: "Mattermost"
description: "A guide on integrating Mattermost with the Authelia OpenID Connect 1.0 Provider with configuration examples and an outline of the available options for SSO."
summary: ""
...
- **Application Root URL:** `https://mattermost.{{< sitevar name="domain" nojs="example.com" >}}/`
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [Mattermost] which
