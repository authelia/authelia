...
description: "A guide on integrating FileBrowser Quantum with the Authelia OpenID Connect 1.0 Provider for single sign-on (SSO) with configuration examples and options."
summary: ""
...
- **Application Root URL:** `https://filebrowser.{{< sitevar name="domain" nojs="example.com" >}}/`
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [FileBrowser Quantum] which will
