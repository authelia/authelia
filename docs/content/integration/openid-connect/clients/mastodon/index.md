---
title: "Mastodon"
description: "A guide on integrating Mastodon with the Authelia OpenID Connect 1.0 Provider with configuration examples and an outline of the available options for SSO."
summary: ""
...
- **Application Root URL:** `https://mastodon.{{< sitevar name="domain" nojs="example.com" >}}/`
...
The following YAML configuration is an example **Authelia** [client configuration] for use with [Mastodon] which will
