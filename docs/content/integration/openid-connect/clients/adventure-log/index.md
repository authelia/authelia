---
title: "AdventureLog"
description: "A guide on integrating AdventureLog with the Authelia OpenID Connect 1.0 Provider for single sign-on (SSO) with configuration examples and available options."
summary: ""
