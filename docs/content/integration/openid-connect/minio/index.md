...
* __Application Root URL:__ `https://minio.{{< sitevar name="domain" >}}/`
  ...
  oidc:
    ...
    clients:
      - client_id: 'minio'
        ...
        redirect_uris:
          - 'https://minio.{{< sitevar name="domain" >}}/oauth_callback'
        scopes:
          - 'openid'
          - 'profile'
          - 'email'
...
4. On the screen that appears, enter the following information:
    ...
    - Redirect URI: `https://minio.{{< sitevar name="domain" >}}/oauth_callback`
