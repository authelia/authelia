...
|                          [OAuth 2.0 Token Exchange]                          |    Yes    | `urn:ietf:params:oauth:grant-type:token-exchange` |                 Only tokens issued by Authelia are supported as the `subject_token` or `actor_token`                  |
...
|                                             [OAuth 2.0 Token Exchange]                                             |    Partial    |                                           [RFC8693]                                           |
