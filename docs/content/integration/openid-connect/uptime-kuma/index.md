...
* __Application Root URL:__ `https://uptime-kuma.{{< sitevar name="domain" >}}/`
* __Authelia Root URL:__ `https://{{< sitevar name="subdomain-authelia" >}}.{{< sitevar name="subdomain-authelia" >}}.{{< sitevar name="domain" >}}/`
* __Client ID:__ `uptime-kuma`
* __Client Secret:__ `insecure_secret`
* __Secured Resource URL:__ `https://application.{{< sitevar name="domain" >}}/`
  ...
  oidc:
    ...
    clients:
      - client_id: 'uptime-kuma'
        ...
        audience:
          - 'https://application.{{< sitevar name="domain" >}}/'
        grant_types:
          - 'client_credentials'
...
4. Configure Authentication as follows:
   ...
   - OAuth Token URL: `https://{{< sitevar name="subdomain-authelia" >}}.{{< sitevar name="domain" >}}/api/oidc/token`
