---
title: "Files"
description: "Configuring Authelia using YAML configuration files including file discovery, loading behavior, multiple file support, and template file filters."
