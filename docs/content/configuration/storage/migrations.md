...
|       25       |     4.39.21      |    Adjusted storage encryption implementation to include HKDF for key derivation and column specific AAD's    |
|       26       |     4.39.21      | Adjusted storage encryption AAD's to be specific to the individual row and column rather than just the column |
