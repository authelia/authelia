---
title: "File"
description: "Configuring the Authelia file-based first factor authentication provider including user database path, search options, password hashing, and watch settings."
