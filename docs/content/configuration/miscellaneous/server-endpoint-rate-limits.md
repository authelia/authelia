...
description: "Configuring the Authelia server endpoint rate limits including bucket-based rate limiting for password resets, second factor, and session elevation."
