---
title: "Miscellaneous"
description: "Configuring miscellaneous Authelia settings including the certificates directory, default redirection URL, theme selection, and privacy policy consent option."
