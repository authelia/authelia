---
title: "Server"
description: "Configuring the Authelia internal web server including the listen address, TLS certificates, security headers, buffer sizes, and timeout settings."
