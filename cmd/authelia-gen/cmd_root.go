...
func newRootCmd() *cobra.Command {
	...
	cmd.PersistentFlags().String(cmdFlagDirEvents, dirEvents, "The events directory in relation to the root")
	...
	cmd.PersistentFlags().String(cmdFlagDocsStaticJSONSchemasWebhooks, dirDocsStaticJSONSchemasWebhooks, "The directory with the docs static webhook JSONSchema files in relation to the docs static JSONSchema directory")
