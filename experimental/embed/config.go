...
func NewNamedConfigFileFilters(valuesFile string, names ...string) (filters []configuration.BytesFilter, err error) {
	if filters, err = configuration.NewFileFilters(valuesFile, names...); err != nil {
