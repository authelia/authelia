...
import { ExternalIdentityPendingLink } from "@models/ExternalIdentity";
...
const ExternalIdentityLinkPendingPanel = function (props: Props) {
    ...
    return (
        <Card id={"external-identity-link-pending-panel"}>
            <CardContent className="grid grid-cols-12 gap-4 p-4">
                ...
                <div className="col-span-12 flex gap-2">
                    <Button
                        id={"external-identity-link-accept"}
                        variant={"outline"}
                        color={"primary"}
                    ...
                    <Button
                        id={"external-identity-link-decline"}
                        variant={"outline"}
                        color={"destructive"}
...
export default ExternalIdentityLinkPendingPanel;
