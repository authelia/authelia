...
export const UserExternalIdentityLinksPath = basePath + "/api/user/identity/links";
export const UserExternalIdentityLinkPath = basePath + "/api/user/identity/link";
export const UserExternalIdentityLinkPendingPath = basePath + "/api/user/identity/link/pending";
