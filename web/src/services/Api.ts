...
export const InitiateChangePasswordIdentityVerificationPath = basePath + "/api/change-password";
export const CompleteChangePasswordIdentityVerificationPath = basePath + "/api/change-password";
