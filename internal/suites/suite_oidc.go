...
func init() {
	...
	GlobalRegistry.Register(oidcSuiteName, Suite{
		...
		Description: `This suite has been created to test Authelia as an OpenID Connect 1.0 Provider using a
client application registered against it, with Redis backed sessions.`,
	})
}
