...
const (
	externalIdentityCallbackPathFmt      = "/api/identity/%s/callback"
	externalIdentityStartPathFmt         = "/api/firstfactor/external-identity/%s"
	...
	externalIdentityLinkPath             = "/external-identity/link"
	externalIdentityLinkProviderQueryArg = "link_provider"
	externalIdentityErrorQueryArg        = "external_identity_error"
