...
//
//	mockgen -copyright_file ../mocks/LICENSE.header -write_package_comment=false -package authentication -destination ldap_client_dialer_mock_test.go -mock_names LDAPClientDialer=MockLDAPClientDialer github.com/authelia/authelia/v4/internal/authentication LDAPClientDialer
//
