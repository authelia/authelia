...
//
//	mockgen -copyright_file ../mocks/LICENSE.header -write_package_comment=false -package authentication -destination ldap_client_mock_test.go -mock_names LDAPExtendedClient=MockLDAPClient github.com/authelia/authelia/v4/internal/authentication LDAPExtendedClient
//
