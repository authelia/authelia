...
// RFC2307bisUserManagement is the UserManagementProvider implementation for the RFC2307bis, FreeIPA, LLDAP, and GLAuth LDAP implementations.
...
// GetGroups returns the LDAP entries for all groups.
