...
func (p *LDAPUserProvider) setPassword(client LDAPBaseClient, profile *ldapUserProfile, username, oldPassword, newPassword string) (err error) {
...
func (p *LDAPUserProvider) search(client LDAPBaseClient, request *ldap.SearchRequest) (result *ldap.SearchResult, err error) {
...
func (p *LDAPUserProvider) getUserProfile(client LDAPBaseClient, username string) (profile *ldapUserProfile, err error) {
...
func (p *LDAPUserProvider) getUserProfileExtended(client LDAPBaseClient, username string) (profile *ldapUserProfileExtended, err error) {
	// Search for the given username.
	request := ldap.NewSearchRequest(
		p.usersBaseDN, ldap.ScopeWholeSubtree, ldap.NeverDerefAliases,
...
func (p *LDAPUserProvider) getUserGroups(client LDAPBaseClient, username string, profile *ldapUserProfile) (groups []string, err error) {
	request := ldap.NewSearchRequest(
...
func (p *LDAPUserProvider) getUserGroupsRequestFilter(client LDAPBaseClient, username string, _ *ldapUserProfile, request *ldap.SearchRequest) (groups []string, err error) {
	var result *ldap.SearchResult
...
func (p *LDAPUserProvider) getUserGroupsRequestMemberOf(client LDAPBaseClient, username string, profile *ldapUserProfile, request *ldap.SearchRequest) (groups []string, err error) {
	var result *ldap.SearchResult
...
func (p *LDAPUserProvider) modify(client LDAPBaseClient, modifyRequest *ldap.ModifyRequest) (err error) {
...
func (p *LDAPUserProvider) pwdModify(client LDAPBaseClient, pwdModifyRequest *ldap.PasswordModifyRequest) (err error) {
