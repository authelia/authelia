...
// IsExtraAttribute returns true if fieldName is a configured extra attribute.
...
// GetUser returns the extended user details for a given username.
...
// ListUsers returns the extended user details for all users.
