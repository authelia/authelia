...
func ServeIndex(publicDir, base, themename, thememaincolor, themesecondarycolor, rememberMe, resetPassword string) fasthttp.RequestHandler {
	...
	return func(ctx *fasthttp.RequestCtx) {
		...
		err := tmpl.Execute(ctx.Response.BodyWriter(), struct{ Base, CSPNonce, ThemeName, ThemeMainColor, ThemeSecondaryColor, RememberMe, ResetPassword string }{Base: base, CSPNonce: nonce, ThemeName: themename, ThemeMainColor: thememaincolor, ThemeSecondaryColor: themesecondarycolor, RememberMe: rememberMe, ResetPassword: resetPassword})
		if err != nil {
