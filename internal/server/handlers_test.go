...
// DELETE /api/user/identity/link/pending resolves to the pending decline handler rather than the id delete
...
func TestHandlerMainExternalIdentityLinkRoutes(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			"/api/user/identity/link/pending",
