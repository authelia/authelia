...
func TestWebAuthnGetUserx(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			user, err := getWebAuthnUserByRPID(mock.Ctx, tc.have, tc.haveDisplay, tc.haveRPID)
			if tc.err == "" {
...
func TestWebAuthnGetUserWithErr(t *testing.T) {
	...
	user, err := getWebAuthnUserByRPID(ctx.Ctx, userSession.Username, userSession.DisplayName, exampleDotCom)
...
func TestWebauthnCredentialCreationIsDiscoverable(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			assert.Equal(t, tc.expected, webauthnCredentialCreationIsDiscoverable(mock.Ctx, tc.have))
