...
func TestFirstFactorExternalIdentityCallbackGET(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.Name, func(t *testing.T) {
			...
			mock.Ctx.Request.SetRequestURI("/api/firstfactor/external-identity/" + tc.Provider + "/callback?" + query.Encode())
...
func newTestRelyingPartyProvidersWithUpstream(tokenEndpoint string, key *rsa.PrivateKey, trust bool) *externalidentity.Providers {
	return newTestRelyingPartyProvidersWithUpstreamUserInfo(tokenEndpoint, "", key, trust)
}

func newTestRelyingPartyProvidersWithUpstreamUserInfo(tokenEndpoint, userinfoEndpoint string, key *rsa.PrivateKey, trust bool) *externalidentity.Providers {
