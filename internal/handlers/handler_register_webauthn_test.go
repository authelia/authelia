...
func TestWebAuthnRegistrationPUT(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			regexp.MustCompile(`^\{"status":"OK","data":\{"publicKey":\{"rp":\{"name":"Authelia","id":"example.com"},"user":\{"name":"john","displayName":"john","id":"ZytlJlVuWzdgN2BxTyI8Uy9uS2xpJSdsT2ZsJUA5UEBve1c2NENCKDNSWWphaGVCJEhlQ3wpYT9HQGBwIi8zQA=="},"challenge":"[a-zA-Z0-9/_-]+={0,2}","pubKeyCredParams":\[\{"type":"public-key","alg":-7},\{"type":"public-key","alg":-35},\{"type":"public-key","alg":-36},\{"type":"public-key","alg":-257},\{"type":"public-key","alg":-258},\{"type":"public-key","alg":-259},\{"type":"public-key","alg":-37},\{"type":"public-key","alg":-38},\{"type":"public-key","alg":-39},\{"type":"public-key","alg":-8}],"timeout":60000,"authenticatorSelection":\{},"attestation":"indirect","extensions":\{"credProps":true}}}}$`),
			fasthttp.StatusOK,
			nil,
		},
		{
