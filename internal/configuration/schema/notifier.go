...
type NotifierSMTP struct {
	...
	DisableRequireTLS   bool          `koanf:"disable_require_tls" yaml:"disable_require_tls" toml:"disable_require_tls" json:"disable_require_tls" jsonschema:"default=false,title=Disable Require TLS" jsonschema_description:"Disables the requirement to use TLS. This means sensitive data such as Authelia password reset links and SMTP auth credentials might be sent over an unencrypted connection. Only enable this if you know what you are doing!"`
