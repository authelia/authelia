...
type NotifierSMTP struct {
	...
	DisableRequireTLS   bool          `koanf:"disable_require_tls" yaml:"disable_require_tls" toml:"disable_require_tls" json:"disable_require_tls" jsonschema:"default=false,title=Disable Require TLS" jsonschema_description:"Disables the requirement to use TLS."`
