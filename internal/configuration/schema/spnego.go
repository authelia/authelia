...
type SPNEGO struct {
	...
	Realm     string `koanf:"kerberos_realm" json:"kerberos_realm" jsonschema:"title=Kerberos Realm" jsonschema_description:"The Kerberos realm to use for SPNEGO authentication."`
}
