...
type RedisCache struct {
	...
	Database                   int           `koanf:"database" yaml:"database,omitempty" toml:"database,omitempty" json:"database,omitempty" jsonschema:"default=0,title=Database" jsonschema_description:"The database to use for the Redis server."`
	...
	ConnectionLifetime         time.Duration `koanf:"connection_lifetime" yaml:"connection_lifetime,omitempty" toml:"connection_lifetime,omitempty" json:"connection_lifetime,omitempty" jsonschema:"default=0,title=Connection Lifetime" jsonschema_description:"The maximum lifetime of a connection before it is closed and replaced. A value of 0 means connections are not closed because of their age."`
	IdleTimeout                time.Duration `koanf:"idle_timeout" yaml:"idle_timeout,omitempty" toml:"idle_timeout,omitempty" json:"idle_timeout,omitempty" jsonschema:"default=30 minutes,title=Idle Timeout" jsonschema_description:"The connection idle timeout for the Redis server."`
	PoolTimeout                time.Duration `koanf:"pool_timeout" yaml:"pool_timeout,omitempty" toml:"pool_timeout,omitempty" json:"pool_timeout,omitempty" jsonschema:"title=Pool Timeout" jsonschema_description:"The pool timeout for the Redis server. Defaults to the read timeout plus 1 second."`
	MinimumRetryBackoff        time.Duration `koanf:"minimum_retry_backoff" yaml:"minimum_retry_backoff,omitempty" toml:"minimum_retry_backoff,omitempty" json:"minimum_retry_backoff,omitempty" jsonschema:"default=8 milliseconds,title=Minimum Retry Backoff" jsonschema_description:"The minimum retry backoff to use when connecting to the Redis server."`
	MaximumRetryBackoff        time.Duration `koanf:"maximum_retry_backoff" yaml:"maximum_retry_backoff,omitempty" toml:"maximum_retry_backoff,omitempty" json:"maximum_retry_backoff,omitempty" jsonschema:"default=512 milliseconds,title=Maximum Retry Backoff" jsonschema_description:"The maximum retry backoff to use when connecting to the Redis server."`
	...
	ConnectionLifetimeJitter   time.Duration `koanf:"connection_lifetime_jitter" yaml:"connection_lifetime_jitter,omitempty" toml:"connection_lifetime_jitter,omitempty" json:"connection_lifetime_jitter,omitempty" jsonschema:"default=0,title=Connection Lifetime Jitter" jsonschema_description:"The absolute jitter applied to the connection lifetime to prevent all connections expiring simultaneously. Must not be greater than the connection lifetime."`
...
type RedisSentinelCache struct {
	...
	RouteByLatency             bool          `koanf:"route_by_latency" yaml:"route_by_latency,omitempty" toml:"route_by_latency,omitempty" json:"route_by_latency,omitempty" jsonschema:"default=false,title=Route By Latency" jsonschema_description:"Route commands to the node with the lowest latency."`
	RouteRandomly              bool          `koanf:"route_randomly" yaml:"route_randomly,omitempty" toml:"route_randomly,omitempty" json:"route_randomly,omitempty" jsonschema:"default=false,title=Route Randomly" jsonschema_description:"Route commands randomly to nodes."`
	Database                   int           `koanf:"database" yaml:"database,omitempty" toml:"database,omitempty" json:"database,omitempty" jsonschema:"default=0,title=Database" jsonschema_description:"The database to use for the Redis server."`
	Username                   string        `koanf:"username" yaml:"username,omitempty" toml:"username,omitempty" json:"username,omitempty" jsonschema:"title=Username" jsonschema_description:"The username to use for the Redis server."`
	Password                   string        `koanf:"password" yaml:"password,omitempty" toml:"password,omitempty" json:"password,omitempty" jsonschema:"title=Password" jsonschema_description:"The password to use for the Redis server."`
	TLS                        *TLS          `koanf:"tls" yaml:"tls,omitempty" toml:"tls,omitempty" json:"tls,omitempty" jsonschema:"title=TLS" jsonschema_description:"The TLS configuration for the Redis server."`
...
type RedisClusterCache struct {
	...
	RouteByReplica             bool          `koanf:"route_by_replica" yaml:"route_by_replica,omitempty" toml:"route_by_replica,omitempty" json:"route_by_replica,omitempty" jsonschema:"default=false,title=Route By Replica" jsonschema_description:"Route read-only commands to replica nodes."`
	RouteByLatency             bool          `koanf:"route_by_latency" yaml:"route_by_latency,omitempty" toml:"route_by_latency,omitempty" json:"route_by_latency,omitempty" jsonschema:"default=false,title=Route By Latency" jsonschema_description:"Route commands to the node with the lowest latency."`
	RouteRandomly              bool          `koanf:"route_randomly" yaml:"route_randomly,omitempty" toml:"route_randomly,omitempty" json:"route_randomly,omitempty" jsonschema:"default=false,title=Route Randomly" jsonschema_description:"Route commands randomly to nodes."`
	Username                   string        `koanf:"username" yaml:"username,omitempty" toml:"username,omitempty" json:"username,omitempty" jsonschema:"title=Username" jsonschema_description:"The username to use for the Redis server."`
	Password                   string        `koanf:"password" yaml:"password,omitempty" toml:"password,omitempty" json:"password,omitempty" jsonschema:"title=Password" jsonschema_description:"The password to use for the Redis server."`
...
var DefaultRedisCacheConfiguration = RedisCache{
	...
	MinimumRetryBackoff:        time.Millisecond * 8,
	MaximumRetryBackoff:        time.Millisecond * 512,
	MaximumRetries:             3,
	PoolMaximumIdleConnections: 10,
	PoolMaximumConnections:     10,
	DialerRetries:              5,
