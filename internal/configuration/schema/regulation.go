...
type Regulation struct {
	Mode       string        `koanf:"mode" json:"mode" jsonschema:"default=user,enum=user,enum=ip,enum=both,title=Regulation Mode" jsonschema_description:"The mode to use for regulation."`
