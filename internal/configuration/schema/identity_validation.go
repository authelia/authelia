...
type IdentityValidationElevatedSession struct {
	...
	Characters          int           `koanf:"characters" yaml:"characters" toml:"characters" json:"otp_characters" jsonschema:"title=OTP Characters,minimum=6,maximum=12,default=8" jsonschema_description:"Number of characters in the generated OTP codes."`
