...
var DefaultOpenIDConnectClientConfiguration = IdentityProvidersOpenIDConnectClient{
	...
	Scopes:                         []string{scopeOpenID, scopeGroups, scopeProfile, scopeEmail},
	ResponseTypes:                  []string{responseTypeCode},
	ResponseModes:                  []string{responseModeFormPost},
	AuthorizationSignedResponseAlg: signingAlgRS256,
	IDTokenSignedResponseAlg:       signingAlgRS256,
	AccessTokenSignedResponseAlg:   signingAlgNone,
	UserinfoSignedResponseAlg:      signingAlgNone,
	IntrospectionSignedResponseAlg: signingAlgNone,
