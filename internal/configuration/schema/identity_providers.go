...
type IdentityProvidersOpenIDConnectClient struct {
	...
	LogoURI             *url.URL        `koanf:"logo_uri" yaml:"logo_uri,omitempty" toml:"logo_uri,omitempty" json:"logo_uri" jsonschema:"title=Logo URI" jsonschema_description:"URL of an image displayed to End-Users on the consent screen as defined by OpenID Connect Dynamic Client Registration 1.0; must be an absolute https URL pointing to a valid image file."`
