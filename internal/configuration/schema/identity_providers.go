...
type IdentityProvidersOpenIDConnectClient struct {
	...
	UserinfoSignedResponseAlg      string `koanf:"userinfo_signed_response_alg" yaml:"userinfo_signed_response_alg,omitempty" toml:"userinfo_signed_response_alg,omitempty" json:"userinfo_signed_response_alg" jsonschema:"default=none,enum=none,enum=RS256,enum=RS384,enum=RS512,enum=ES256,enum=ES384,enum=ES512,enum=PS256,enum=PS384,enum=PS512,title=Userinfo Signing Algorithm" jsonschema_description:"The JOSE signing algorithm (JWS) this client uses to sign the Userinfo objects that it generates and responds with. i.e. the JWS 'alg' value."`
	...
	UserinfoEncryptedResponseAlg   string `koanf:"userinfo_encrypted_response_alg" yaml:"userinfo_encrypted_response_alg,omitempty" toml:"userinfo_encrypted_response_alg,omitempty" json:"userinfo_encrypted_response_alg" jsonschema:"enum=RSA1_5,enum=RSA-OAEP,enum=RSA-OAEP-256,enum=A128KW,enum=A192KW,enum=A256KW,enum=dir,enum=ECDH-ES,enum=ECDH-ES+A128KW,enum=ECDH-ES+A192KW,enum=ECDH-ES+A256KW,enum=A128GCMKW,enum=A192GCMKW,enum=A256GCMKW,enum=PBES2-HS256+A128KW,enum=PBES2-HS384+A192KW,enum=PBES2-HS512+A256KW,title=Userinfo Encryption Algorithm (CEK)" jsonschema_description:"The JOSE encryption algorithm (JWE) this client uses to encrypt the Userinfo objects CEK that it generates and responds with. i.e. the JWE 'alg' value."`
	UserinfoEncryptedResponseEnc   string `koanf:"userinfo_encrypted_response_enc" yaml:"userinfo_encrypted_response_enc,omitempty" toml:"userinfo_encrypted_response_enc,omitempty" json:"userinfo_encrypted_response_enc" jsonschema:"enum=A128CBC-HS256,enum=A192CBC-HS384,enum=A256CBC-HS512,enum=A128GCM,enum=A192GCM,enum=A256GCM,title=Userinfo Encryption Algorithm (Content)" jsonschema_description:"The JOSE encryption algorithm (JWE) this client uses to encrypt the Userinfo objects content that it generates and responds with. i.e. the JWE 'enc' value."`
	...
	IntrospectionEncryptedResponseAlg   string `koanf:"introspection_encrypted_response_alg" yaml:"introspection_encrypted_response_alg,omitempty" toml:"introspection_encrypted_response_alg,omitempty" json:"introspection_encrypted_response_alg" jsonschema:"enum=RSA1_5,enum=RSA-OAEP,enum=RSA-OAEP-256,enum=A128KW,enum=A192KW,enum=A256KW,enum=dir,enum=ECDH-ES,enum=ECDH-ES+A128KW,enum=ECDH-ES+A192KW,enum=ECDH-ES+A256KW,enum=A128GCMKW,enum=A192GCMKW,enum=A256GCMKW,enum=PBES2-HS256+A128KW,enum=PBES2-HS384+A192KW,enum=PBES2-HS512+A256KW,title=Introspection Encryption Algorithm (CEK)" jsonschema_description:"The JOSE encryption algorithm (JWE) this client uses to encrypt the Introspection objects CEK that it generates and responds with. i.e. the JWE 'alg' value."`
	IntrospectionEncryptedResponseEnc   string `koanf:"introspection_encrypted_response_enc" yaml:"introspection_encrypted_response_enc,omitempty" toml:"introspection_encrypted_response_enc,omitempty" json:"introspection_encrypted_response_enc" jsonschema:"enum=A128CBC-HS256,enum=A192CBC-HS384,enum=A256CBC-HS512,enum=A128GCM,enum=A192GCM,enum=A256GCM,title=Introspection Encryption Algorithm (Content)" jsonschema_description:"The JOSE encryption algorithm (JWE) this client uses to encrypt the Introspection objects content that it generates and responds with. i.e. the JWE 'enc' value."`
	...
	RequestObjectSigningAlg    string `koanf:"request_object_signing_alg" yaml:"request_object_signing_alg,omitempty" toml:"request_object_signing_alg,omitempty" json:"request_object_signing_alg" jsonschema:"enum=RS256,enum=RS384,enum=RS512,enum=ES256,enum=ES384,enum=ES512,enum=PS256,enum=PS384,enum=PS512,title=Request Object Signing Algorithm" jsonschema_description:"The JOSE signing algorithm (JWS) this client must use to sign Request Objects that it uses. i.e. the JWS 'alg' value."`
