...
type Configuration struct {
	...
	Cache                 Cache                 `koanf:"cache" yaml:"cache,omitempty" toml:"cache,omitempty" json:"cache,omitempty" jsonschema:"title=Cache" jsonschema_description:"Cache Configuration."`
