...
type Configuration struct {
	...
	SPNEGO                SPNEGO                `koanf:"spnego" json:"spnego" jsonschema:"title=SPNEGO Configuration" jsonschema_description:"Configuration for SPNEGO Krb5 based-authentication."`
