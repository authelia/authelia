...
type Configuration struct {
	...
	RecoveryCodes         RecoveryCodes         `koanf:"recovery_codes" yaml:"recovery_codes,omitempty" toml:"recovery_codes,omitempty" json:"recovery_codes,omitempty" jsonschema:"title=Recovery Codes" jsonschema_description:"Recovery Codes Configuration."`
