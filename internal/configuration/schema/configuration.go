...
type Configuration struct {
	...
	Telegram              *Telegram             `koanf:"telegram" yaml:"telegram,omitempty" toml:"telegram,omitempty" json:"telegram,omitempty" jsonschema:"title=Telegram" jsonschema_description:"Telegram Authentication Configuration."`
