...
type ServerEndpointsAuthzAuthnStrategy struct {
	...
	CookieSessionResponseCookieHeader bool          `koanf:"cookie_session_response_cookie_header" yaml:"cookie_session_response_cookie_header,omitempty" toml:"cookie_session_response_cookie_header,omitempty" json:"cookie_session_response_cookie_header,omitempty" jsonschema:"default=false,title=Cookie Session Response Cookie Header" jsonschema_description:"When enabled this option makes this endpoint respond with a Cookie header which is absent the configured Authelia cookie for the relevant domain."`
}
