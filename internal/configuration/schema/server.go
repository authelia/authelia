...
type ServerEndpointsAuthz struct {
	...
	Headers         ServerEndpointsAuthzHeaders         `koanf:"headers" yaml:"headers,omitempty" toml:"headers,omitempty" json:"headers,omitempty" jsonschema:"title=Headers" jsonschema_description:"The Authorization headers configuration for this endpoint."`
...
// ServerEndpointsAuthzHeaders is the Authz endpoints headers configuration for the HTTP server.
