...
// AuthenticationBackendFileUserManagement represents the user management configuration for the file authentication backend.
...
// AuthenticationBackendLDAPUserManagement represents the user management configuration for the LDAP authentication backend.
