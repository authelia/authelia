...
var Keys = []string{
	...
	"identity_providers.oidc.issuer_jwks.default_key_id",
	"identity_providers.oidc.issuer_jwks.keys",
	"identity_providers.oidc.issuer_jwks.keys.*.use",
	"identity_providers.oidc.issuer_jwks.keys.*.algorithm",
	"identity_providers.oidc.issuer_jwks.keys.*.key",
	"identity_providers.oidc.issuer_jwks.keys.*.certificate_chain",
