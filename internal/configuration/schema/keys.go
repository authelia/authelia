...
var Keys = []string{
	...
	"authentication_backend.openid_connect.providers",
	"authentication_backend.openid_connect.providers[].authentication_methods_reference",
	"authentication_backend.openid_connect.providers[].authentication_methods_reference.trust",
	"authentication_backend.openid_connect.providers[].client_id",
	"authentication_backend.openid_connect.providers[].client_secret",
	"authentication_backend.openid_connect.providers[].discovery",
	"authentication_backend.openid_connect.providers[].discovery.disable",
	"authentication_backend.openid_connect.providers[].endpoints",
	"authentication_backend.openid_connect.providers[].endpoints.authorization",
	"authentication_backend.openid_connect.providers[].endpoints.jwks",
	"authentication_backend.openid_connect.providers[].endpoints.token",
	"authentication_backend.openid_connect.providers[].id",
	"authentication_backend.openid_connect.providers[].id_token_signed_response_alg",
	"authentication_backend.openid_connect.providers[].issuer",
	"authentication_backend.openid_connect.providers[].jwks",
	"authentication_backend.openid_connect.providers[].jwks[].algorithm",
	"authentication_backend.openid_connect.providers[].jwks[].certificate_chain",
	"authentication_backend.openid_connect.providers[].jwks[].key",
	"authentication_backend.openid_connect.providers[].jwks[].key_id",
	"authentication_backend.openid_connect.providers[].jwks[].use",
	"authentication_backend.openid_connect.providers[].name",
	"authentication_backend.openid_connect.providers[].pkce",
	"authentication_backend.openid_connect.providers[].pkce.challenge_method",
	"authentication_backend.openid_connect.providers[].scopes",
	"authentication_backend.openid_connect.providers[].token_endpoint_auth_method",
	...
	"server.endpoints.rate_limits.openid_connect_relying_party_callback.buckets",
	"server.endpoints.rate_limits.openid_connect_relying_party_callback.buckets[].period",
	"server.endpoints.rate_limits.openid_connect_relying_party_callback.buckets[].requests",
	"server.endpoints.rate_limits.openid_connect_relying_party_callback.enable",
	"server.endpoints.rate_limits.openid_connect_relying_party_start.buckets",
	"server.endpoints.rate_limits.openid_connect_relying_party_start.buckets[].period",
	"server.endpoints.rate_limits.openid_connect_relying_party_start.buckets[].requests",
