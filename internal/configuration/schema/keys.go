...
var Keys = []string{
	...
	"webhooks.destinations[].address",
	"webhooks.destinations[].authentication",
	"webhooks.destinations[].authentication.basic.password",
	"webhooks.destinations[].authentication.basic.username",
	"webhooks.destinations[].authentication.bearer.header",
	"webhooks.destinations[].authentication.bearer.scheme",
	"webhooks.destinations[].authentication.bearer.token",
	"webhooks.destinations[].batch",
	"webhooks.destinations[].batch.immediate",
	"webhooks.destinations[].batch.max_wait",
	"webhooks.destinations[].batch.size",
	"webhooks.destinations[].buffer_size",
	"webhooks.destinations[].disable_redaction",
	"webhooks.destinations[].events",
	"webhooks.destinations[].headers",
	"webhooks.destinations[].headers.*",
	"webhooks.destinations[].name",
	"webhooks.destinations[].retry",
	"webhooks.destinations[].retry.attempts",
	"webhooks.destinations[].retry.initial_interval",
	"webhooks.destinations[].retry.maximum_interval",
	"webhooks.destinations[].signature",
	"webhooks.destinations[].signature.algorithm",
	"webhooks.destinations[].signature.secret",
	"webhooks.destinations[].timeout",
	"webhooks.destinations[].tls",
	"webhooks.destinations[].tls.certificate_chain",
	"webhooks.destinations[].tls.maximum_version",
	"webhooks.destinations[].tls.minimum_version",
	"webhooks.destinations[].tls.private_key",
	"webhooks.destinations[].tls.server_name",
	"webhooks.destinations[].tls.skip_verify",
	"webhooks.destinations[].validation",
	"webhooks.destinations[].validation.disable",
	"webhooks.destinations[].validation.force_origin",
	"webhooks.destinations[].validation.origin",
	"webhooks.destinations[].validation.rate",
	"webhooks.startup_check",
}
