...
var Keys = []string{
	...
	"session.domains",
	"session.domains[].name",
	"session.domains[].domain",
	"session.domains[].portal_url",
	"session.domains[].same_site",
	"session.domains[].expiration",
	"session.domains[].inactivity",
	"session.domains[].remember_me_duration",
	"session.redis.host",
	"session.redis.port",
