...
var Keys = []string{
	...
	"definitions.webhooks.*",
	"definitions.webhooks.*.headers",
	"definitions.webhooks.*.headers.*",
	"definitions.webhooks.*.method",
	"definitions.webhooks.*.timeout",
	"definitions.webhooks.*.tls.certificate_chain",
	"definitions.webhooks.*.tls.maximum_version",
	"definitions.webhooks.*.tls.minimum_version",
	"definitions.webhooks.*.tls.private_key",
	"definitions.webhooks.*.tls.server_name",
	"definitions.webhooks.*.tls.skip_verify",
	"definitions.webhooks.*.url",
	"duo_api.disable",
