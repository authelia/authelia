...
var Keys = []string{
	...
	"authentication_backend.db.password.argon2.memory",
	"authentication_backend.db.password.argon2.parallelism",
	"authentication_backend.db.password.argon2.key_length",
	"authentication_backend.db.password.argon2.salt_length",
	"authentication_backend.db.password.sha2crypt.variant",
	"authentication_backend.db.password.sha2crypt.iterations",
	"authentication_backend.db.password.sha2crypt.salt_length",
	"authentication_backend.db.password.pbkdf2.variant",
	"authentication_backend.db.password.pbkdf2.iterations",
	"authentication_backend.db.password.pbkdf2.salt_length",
	"authentication_backend.db.password.bcrypt.variant",
	"authentication_backend.db.password.bcrypt.cost",
	"authentication_backend.db.password.scrypt.iterations",
	"authentication_backend.db.password.scrypt.block_size",
	"authentication_backend.db.password.scrypt.parallelism",
	"authentication_backend.db.password.scrypt.key_length",
	"authentication_backend.db.password.scrypt.salt_length",
	"authentication_backend.db.password.iterations",
	"authentication_backend.db.password.memory",
	"authentication_backend.db.password.parallelism",
	"authentication_backend.db.password.key_length",
	"authentication_backend.db.password.salt_length",
	"authentication_backend.db.search.email",
	"session.name",
	"session.same_site",
	"session.expiration",
	"session.inactivity",
