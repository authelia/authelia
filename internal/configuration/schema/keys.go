...
var Keys = []string{
	...
	"authentication_backend.registration.custom_url",
	"cache.redis.address",
	"cache.redis.connection_lifetime",
	"cache.redis.connection_lifetime_jitter",
	"cache.redis.context_timeout_enabled",
	"cache.redis.database",
	"cache.redis.dial_timeout",
	"cache.redis.dialer_retries",
	"cache.redis.dialer_retry_timeout",
	"cache.redis.failing_timeout",
	"cache.redis.idle_timeout",
	"cache.redis.maximum_concurrent_dials",
	"cache.redis.maximum_retries",
	"cache.redis.maximum_retry_backoff",
	"cache.redis.minimum_retry_backoff",
	"cache.redis.password",
	"cache.redis.pool_fifo",
	"cache.redis.pool_maximum_connections",
	"cache.redis.pool_maximum_idle_connections",
	"cache.redis.pool_minimum_idle_connections",
	"cache.redis.pool_size",
	"cache.redis.pool_timeout",
	"cache.redis.read_buffer_size",
	"cache.redis.read_timeout",
	"cache.redis.tls.certificate_chain",
	"cache.redis.tls.maximum_version",
	"cache.redis.tls.minimum_version",
	"cache.redis.tls.private_key",
	"cache.redis.tls.server_name",
	"cache.redis.tls.skip_verify",
	"cache.redis.username",
	"cache.redis.write_buffer_size",
	"cache.redis.write_timeout",
	"cache.redis_cluster.addresses",
	"cache.redis_cluster.cluster_state_reload_interval",
	"cache.redis_cluster.connection_lifetime",
	"cache.redis_cluster.connection_lifetime_jitter",
	"cache.redis_cluster.context_timeout_enabled",
	"cache.redis_cluster.dial_timeout",
	"cache.redis_cluster.dialer_retries",
	"cache.redis_cluster.dialer_retry_timeout",
	"cache.redis_cluster.failing_timeout",
	"cache.redis_cluster.idle_timeout",
	"cache.redis_cluster.maximum_concurrent_dials",
	"cache.redis_cluster.maximum_redirects",
	"cache.redis_cluster.maximum_retries",
	"cache.redis_cluster.maximum_retry_backoff",
	"cache.redis_cluster.minimum_retry_backoff",
	"cache.redis_cluster.password",
	"cache.redis_cluster.pool_fifo",
	"cache.redis_cluster.pool_maximum_connections",
	"cache.redis_cluster.pool_maximum_idle_connections",
	"cache.redis_cluster.pool_minimum_idle_connections",
	"cache.redis_cluster.pool_size",
	"cache.redis_cluster.pool_timeout",
	"cache.redis_cluster.read_buffer_size",
	"cache.redis_cluster.read_timeout",
	"cache.redis_cluster.route_by_latency",
	"cache.redis_cluster.route_by_replica",
	"cache.redis_cluster.route_randomly",
	"cache.redis_cluster.tls.certificate_chain",
	"cache.redis_cluster.tls.maximum_version",
	"cache.redis_cluster.tls.minimum_version",
	"cache.redis_cluster.tls.private_key",
	"cache.redis_cluster.tls.server_name",
	"cache.redis_cluster.tls.skip_verify",
	"cache.redis_cluster.username",
	"cache.redis_cluster.write_buffer_size",
	"cache.redis_cluster.write_timeout",
	"cache.redis_sentinel.addresses",
	"cache.redis_sentinel.connection_lifetime",
	"cache.redis_sentinel.connection_lifetime_jitter",
	"cache.redis_sentinel.context_timeout_enabled",
	"cache.redis_sentinel.database",
	"cache.redis_sentinel.dial_timeout",
	"cache.redis_sentinel.dialer_retries",
	"cache.redis_sentinel.dialer_retry_timeout",
	"cache.redis_sentinel.failing_timeout",
	"cache.redis_sentinel.idle_timeout",
	"cache.redis_sentinel.master_name",
	"cache.redis_sentinel.maximum_concurrent_dials",
	"cache.redis_sentinel.maximum_retries",
	"cache.redis_sentinel.maximum_retry_backoff",
	"cache.redis_sentinel.minimum_retry_backoff",
	"cache.redis_sentinel.password",
	"cache.redis_sentinel.pool_fifo",
	"cache.redis_sentinel.pool_maximum_connections",
	"cache.redis_sentinel.pool_maximum_idle_connections",
	"cache.redis_sentinel.pool_minimum_idle_connections",
	"cache.redis_sentinel.pool_size",
	"cache.redis_sentinel.pool_timeout",
	"cache.redis_sentinel.read_buffer_size",
	"cache.redis_sentinel.read_timeout",
	"cache.redis_sentinel.replica_only",
	"cache.redis_sentinel.route_by_latency",
	"cache.redis_sentinel.route_randomly",
	"cache.redis_sentinel.sentinel_mode",
	"cache.redis_sentinel.sentinel_password",
	"cache.redis_sentinel.sentinel_username",
	"cache.redis_sentinel.tls.certificate_chain",
	"cache.redis_sentinel.tls.maximum_version",
	"cache.redis_sentinel.tls.minimum_version",
	"cache.redis_sentinel.tls.private_key",
	"cache.redis_sentinel.tls.server_name",
	"cache.redis_sentinel.tls.skip_verify",
	"cache.redis_sentinel.use_disconnected_replicas",
	"cache.redis_sentinel.username",
	"cache.redis_sentinel.write_buffer_size",
	"cache.redis_sentinel.write_timeout",
	...
	"server.endpoints.health.cache",
	"server.endpoints.health.detailed",
	"server.endpoints.health.providers",
	"server.endpoints.health.verbose",
	"server.endpoints.rate_limits.health.buckets",
	"server.endpoints.rate_limits.health.buckets[].period",
	"server.endpoints.rate_limits.health.buckets[].requests",
	"server.endpoints.rate_limits.health.enable",
	...
	"totp.apps.apple_store.disable",
	"totp.apps.apple_store.url",
	"totp.apps.google_play.disable",
	"totp.apps.google_play.url",
	"totp.digits",
	"totp.disable",
