...
var Keys = []string{
	...
	"duo_api.secret_key",
	"duo_api.tls.certificate_chain",
	"duo_api.tls.maximum_version",
	"duo_api.tls.minimum_version",
	"duo_api.tls.private_key",
	"duo_api.tls.server_name",
	"duo_api.tls.skip_verify",
