...
var Keys = []string{
	...
	"identity_providers.oidc.authorization_bearers.redirect_uri",
	"identity_providers.oidc.authorization_bearers.configurations",
	"identity_providers.oidc.authorization_bearers.configurations[].url_prefixes",
	"identity_providers.oidc.authorization_bearers.configurations[].client_id",
	"identity_providers.oidc.authorization_bearers.configurations[].secret",
	"identity_providers.oidc.authorization_bearers.configurations[].scopes",
	"identity_providers.oidc.authorization_bearers.configurations[].token_type",
