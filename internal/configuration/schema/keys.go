...
var Keys = []string{
	...
	"server.endpoints.rate_limits.second_factor_recovery_code.buckets",
	"server.endpoints.rate_limits.second_factor_recovery_code.buckets[].period",
	"server.endpoints.rate_limits.second_factor_recovery_code.buckets[].requests",
	"server.endpoints.rate_limits.second_factor_recovery_code.enable",
