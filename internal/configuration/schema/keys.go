...
var Keys = []string{
	...
	"webauthn.extensions_unsolicited_output_policy",
	...
	"webauthn.relying_parties",
	"webauthn.relying_parties.*",
	"webauthn.relying_parties.*.attestation_conveyance_preference",
	"webauthn.relying_parties.*.display_name",
	"webauthn.relying_parties.*.extensions_unsolicited_output_policy",
	"webauthn.relying_parties.*.filtering.permitted_aaguids",
	"webauthn.relying_parties.*.filtering.prohibit_backup_eligibility",
	"webauthn.relying_parties.*.filtering.prohibited_aaguids",
	"webauthn.relying_parties.*.opaque_origins",
	"webauthn.relying_parties.*.origins",
	"webauthn.relying_parties.*.selection_criteria.attachment",
	"webauthn.relying_parties.*.selection_criteria.discoverability",
	"webauthn.relying_parties.*.selection_criteria.user_verification",
	"webauthn.relying_parties.*.timeout",
