...
var Keys = []string{
	...
	"authentication_backend.external_identity.providers",
	"authentication_backend.external_identity.providers[].authentication_methods_reference",
	"authentication_backend.external_identity.providers[].authentication_methods_reference.default",
	"authentication_backend.external_identity.providers[].authentication_methods_reference.override",
	"authentication_backend.external_identity.providers[].authentication_methods_reference.trust",
	"authentication_backend.external_identity.providers[].authorization_response_iss_parameter_supported",
	"authentication_backend.external_identity.providers[].client_id",
	"authentication_backend.external_identity.providers[].client_secret",
	"authentication_backend.external_identity.providers[].discovery",
	"authentication_backend.external_identity.providers[].discovery.disable",
	"authentication_backend.external_identity.providers[].endpoints",
	"authentication_backend.external_identity.providers[].endpoints.authorization",
	"authentication_backend.external_identity.providers[].endpoints.jwks",
	"authentication_backend.external_identity.providers[].endpoints.pushed_authorization_request",
	"authentication_backend.external_identity.providers[].endpoints.token",
	"authentication_backend.external_identity.providers[].endpoints.userinfo",
	"authentication_backend.external_identity.providers[].id",
	"authentication_backend.external_identity.providers[].id_token_signed_response_alg",
	"authentication_backend.external_identity.providers[].issuer",
	"authentication_backend.external_identity.providers[].jwks",
	"authentication_backend.external_identity.providers[].jwks[].algorithm",
	"authentication_backend.external_identity.providers[].jwks[].certificate_chain",
	"authentication_backend.external_identity.providers[].jwks[].key",
	"authentication_backend.external_identity.providers[].jwks[].key_id",
	"authentication_backend.external_identity.providers[].jwks[].use",
	"authentication_backend.external_identity.providers[].logo_uri",
	"authentication_backend.external_identity.providers[].name",
	"authentication_backend.external_identity.providers[].pkce",
	"authentication_backend.external_identity.providers[].pkce.challenge_method",
	"authentication_backend.external_identity.providers[].require_pushed_authorization_requests",
	"authentication_backend.external_identity.providers[].response_mode",
	"authentication_backend.external_identity.providers[].scopes",
	"authentication_backend.external_identity.providers[].shared_redirect_uri",
	"authentication_backend.external_identity.providers[].token_endpoint_auth_method",
	"authentication_backend.external_identity.providers[].type",
	"authentication_backend.external_identity.providers[].userinfo_signed_response_alg",
	...
	"server.endpoints.rate_limits.external_identity_callback.buckets",
	"server.endpoints.rate_limits.external_identity_callback.buckets[].period",
	"server.endpoints.rate_limits.external_identity_callback.buckets[].requests",
	"server.endpoints.rate_limits.external_identity_callback.enable",
	"server.endpoints.rate_limits.external_identity_start.buckets",
	"server.endpoints.rate_limits.external_identity_start.buckets[].period",
	"server.endpoints.rate_limits.external_identity_start.buckets[].requests",
