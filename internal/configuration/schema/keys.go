...
var Keys = []string{
	...
	"identity_providers.oidc.issuer_ec",
	"identity_providers.oidc.issuer_ec[].certificate_chain",
	"identity_providers.oidc.issuer_ec[].private_key",
	...
	"identity_providers.oidc.clients[].idtoken_signing_algorithm",
