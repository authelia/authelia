...
var Keys = []string{
	...
	"identity_providers.oidc.clients[].json_web_keys",
	"identity_providers.oidc.clients[].json_web_keys[].key_id",
	"identity_providers.oidc.clients[].json_web_keys[]",
	"identity_providers.oidc.clients[].json_web_keys[].algorithm",
	"identity_providers.oidc.clients[].json_web_keys[].key",
	"identity_providers.oidc.clients[].json_web_keys[].certificate_chain",
	"identity_providers.oidc.clients[].json_web_keys_uri",
