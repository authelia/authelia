...
type Log struct {
	...
	DisableTimestamp bool   `koanf:"disable_timestamp" yaml:"disable_timestamp" toml:"disable_timestamp" json:"disable_timestamp" jsonschema:"default=false,title=Disable Timestamp" jsonschema_description:"Disables the timestamp in Log messages."`
