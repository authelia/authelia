...
type DuoAPI struct {
	...
	TLS                  *TLS   `koanf:"tls" yaml:"tls,omitempty" toml:"tls,omitempty" json:"tls,omitempty" jsonschema:"title=TLS" jsonschema_description:"The Duo Authorization server TLS connection properties. WARNING: This setting should not be configured if you're actually using Duo Services."`
}
