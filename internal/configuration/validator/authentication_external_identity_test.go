...
func TestValidateAuthenticationBackendExternalIdentity(t *testing.T) {
	testCases := []struct {
		...
		{
			Name: "ShouldAcceptAnHTTPSLogoURI",
			Have: &schema.AuthenticationBackendExternalIdentity{
				Providers: []schema.AuthenticationBackendExternalIdentityProvider{
					{ID: "google", Name: "Google", Issuer: "https://accounts.google.com", ClientID: "abc", ClientSecret: "secret", LogoURI: "https://cdn.example.com/logo.png"},
				},
			},
		},
		{
			Name: "ShouldAcceptAnImageDataLogoURI",
			Have: &schema.AuthenticationBackendExternalIdentity{
				Providers: []schema.AuthenticationBackendExternalIdentityProvider{
					{ID: "google", Name: "Google", Issuer: "https://accounts.google.com", ClientID: "abc", ClientSecret: "secret", LogoURI: "data:image/svg+xml;base64,PHN2Zy8+"},
				},
			},
		},
		{
			Name: "ShouldRaiseErrorOnInsecureLogoURI",
			Have: &schema.AuthenticationBackendExternalIdentity{
				Providers: []schema.AuthenticationBackendExternalIdentityProvider{
					{ID: "google", Name: "Google", Issuer: "https://accounts.google.com", ClientID: "abc", ClientSecret: "secret", LogoURI: "http://cdn.example.com/logo.png"},
				},
			},
			Errors: []string{"authentication_backend: external_identity: providers: provider 'google': option 'logo_uri' must have the 'https' scheme or be a 'data' URI with an image media type but it's configured as 'http://cdn.example.com/logo.png'"},
		},
		{
			Name: "ShouldRaiseErrorOnRelativeLogoURI",
			Have: &schema.AuthenticationBackendExternalIdentity{
				Providers: []schema.AuthenticationBackendExternalIdentityProvider{
					{ID: "google", Name: "Google", Issuer: "https://accounts.google.com", ClientID: "abc", ClientSecret: "secret", LogoURI: "/logo.png"},
				},
			},
			Errors: []string{"authentication_backend: external_identity: providers: provider 'google': option 'logo_uri' must have the 'https' scheme or be a 'data' URI with an image media type but it's configured as '/logo.png'"},
		},
		{
			Name: "ShouldRaiseErrorOnNonImageDataLogoURI",
			Have: &schema.AuthenticationBackendExternalIdentity{
				Providers: []schema.AuthenticationBackendExternalIdentityProvider{
					{ID: "google", Name: "Google", Issuer: "https://accounts.google.com", ClientID: "abc", ClientSecret: "secret", LogoURI: "data:text/html;base64,PGgxLz4="},
				},
			},
			Errors: []string{"authentication_backend: external_identity: providers: provider 'google': option 'logo_uri' must have the 'https' scheme or be a 'data' URI with an image media type but it's configured as 'data:text/html;base64,PGgxLz4='"},
		},
		{
			Name: "ShouldRaiseErrorOnUnparsableLogoURI",
			Have: &schema.AuthenticationBackendExternalIdentity{
				Providers: []schema.AuthenticationBackendExternalIdentityProvider{
					{ID: "google", Name: "Google", Issuer: "https://accounts.google.com", ClientID: "abc", ClientSecret: "secret", LogoURI: "https://cdn.example.com/\x7f"},
				},
			},
			Errors: []string{"authentication_backend: external_identity: providers: provider 'google': option 'logo_uri' must be a valid URL but it could not be parsed: parse \"https://cdn.example.com/\\x7f\": net/url: invalid control character in URL"},
		},
		{
			Name: "ShouldAcceptALogoURIOnABuiltInProvider",
			Have: &schema.AuthenticationBackendExternalIdentity{
				Providers: []schema.AuthenticationBackendExternalIdentityProvider{
					{ID: "discord", Type: "discord", Name: "Discord", ClientID: "abc", ClientSecret: "secret", LogoURI: "https://cdn.example.com/logo.png"},
				},
			},
		},
		{
