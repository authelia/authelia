...
func validateServerEndpointsRateLimits(config *schema.Configuration, validator *schema.StructValidator) {
	...
	validateServerEndpointsRateLimitDefault("second_factor_recovery_code", &config.Server.Endpoints.RateLimits.SecondFactorRecoveryCode, schema.DefaultServerConfiguration.Endpoints.RateLimits.SecondFactorRecoveryCode, validator)
