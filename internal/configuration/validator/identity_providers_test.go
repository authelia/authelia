	...
	testCases := []struct {
		...
		},
		{
			...
			Errors: []string{
				...
				fmt.Sprintf(errFmtOIDCClientInvalidSectorIdentifier, "client-invalid-sector", "https://user:pass@example.com/path?query=abc#fragment", "example.com", "password", "pass"),
			},
		},
		{
