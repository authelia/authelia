...
-----END EC PRIVATE KEY-----`
	...
	x509CertificateEC1 = `
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----`
...
`
	...
	x509CertificateRSA1PrivateKey = `
-----BEGIN RSA PRIVATE KEY-----

M2bM7hO/44RqXcz85A12z8k0T2M3Id2s3Hsq3gtDteZFllo5cMJ1
-----END RSA PRIVATE KEY-----`
...
-----END CERTIFICATE-----`
	...
	x509CACertificateRSAPrivateKey = `
-----BEGIN RSA PRIVATE KEY-----

-----END RSA PRIVATE KEY-----`

	x509CertificateECDSA = `
-----BEGIN CERTIFICATE-----

t9OKIWmrIwcebWeZ
-----END CERTIFICATE-----`

	x509CertificateECDSAPrivateKey = `
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIJoiSONh9hudu9CbluozyxM3kXqywIdMAzRfcY6Nhxq/oAoGCCqGSM49
AwEHoUQDQgAEtdbjPza46bl22PjNzzFZ2CwZUS9/KnwF3mfxIAOYOfhM5bJIkWlx
D+IwZge3XH6Igj4v5ewSF2Nd9Bvmdni7rQ==
-----END EC PRIVATE KEY-----`
...
-----END CERTIFICATE-----`
	...
	x509CACertificateECDSAPrivateKey = `
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEILI+x1ftZQ6hJJ+SDfQWRT8batUx0grNiKki1eJmloYHoAoGCCqGSM49
AwEHoUQDQgAEb/EiIBpmifCI34JdI7luetygue2rTtoNH0QXhtrjMuZNugT29LUz
+DobZQxvGsOY4TXzAQXq4gnTb7enNWFgsQ==
-----END EC PRIVATE KEY-----`
)
