...
func TestMathematicalRead(t *testing.T) {
	p := NewMathematical()
...
func TestMathematicalBytes(t *testing.T) {
	p := NewMathematical()
...
func TestMathematicalBytesCustomErr(t *testing.T) {
	p := NewMathematical()
...
func TestMathematicalBytesCustom(t *testing.T) {
	p := NewMathematical()
...
func TestMathematicalStringCustom(t *testing.T) {
	p := NewMathematical()
...
func TestMathematicalStringCustomErr(t *testing.T) {
	p := NewMathematical()
...
func TestMathematicalIntn(t *testing.T) {
	p := NewMathematical()
...
func TestMathematicalIntnErr(t *testing.T) {
	p := NewMathematical()
...
func TestMathematicalIntErr(t *testing.T) {
	p := NewMathematical()
...
func TestMathematicalInt(t *testing.T) {
	p := NewMathematical()
...
func TestMathematicalPrime(t *testing.T) {
	p := NewMathematical()
