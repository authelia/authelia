...
//
//	mockgen -copyright_file LICENSE.header -package mocks -destination oauth2_storage.go -mock_names Storage=MockOAuth2Storage authelia.com/provider/oauth2 Storage
//
