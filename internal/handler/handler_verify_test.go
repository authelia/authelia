...
func TestShouldVerifyAuthorizationsUsingSessionCookie(t *testing.T) {
	testCases := []Pair{
		...
		{"", "https://test.example.com", "john", []string{"john.doe@example.com"}, authentication.OneFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&title=Access+Denied&url=https%3A%2F%2Ftest.example.com"},
		...
		{"", "https://deny.example.com", "john", []string{"john.doe@example.com"}, authentication.OneFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&title=Access+Denied&url=https%3A%2F%2Fdeny.example.com"},
		{"", "https://test.example.com", "john", []string{"john.doe@example.com"}, authentication.TwoFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&title=Access+Denied&url=https%3A%2F%2Ftest.example.com"},
		...
		{"", "https://deny.example.com", "john", []string{"john.doe@example.com"}, authentication.TwoFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&title=Access+Denied&url=https%3A%2F%2Fdeny.example.com"},
		...
		{"GET", "https://test.example.com", "john", []string{"john.doe@example.com"}, authentication.OneFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=GET&title=Access+Denied&url=https%3A%2F%2Ftest.example.com"},
		...
		{"GET", "https://deny.example.com", "john", []string{"john.doe@example.com"}, authentication.OneFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=GET&title=Access+Denied&url=https%3A%2F%2Fdeny.example.com"},
		{"GET", "https://test.example.com", "john", []string{"john.doe@example.com"}, authentication.TwoFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=GET&title=Access+Denied&url=https%3A%2F%2Ftest.example.com"},
		...
		{"GET", "https://deny.example.com", "john", []string{"john.doe@example.com"}, authentication.TwoFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=GET&title=Access+Denied&url=https%3A%2F%2Fdeny.example.com"},
		...
		{"OPTIONS", "https://test.example.com", "john", []string{"john.doe@example.com"}, authentication.OneFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=OPTIONS&title=Access+Denied&url=https%3A%2F%2Ftest.example.com"},
		...
		{"OPTIONS", "https://deny.example.com", "john", []string{"john.doe@example.com"}, authentication.OneFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=OPTIONS&title=Access+Denied&url=https%3A%2F%2Fdeny.example.com"},
		{"OPTIONS", "https://test.example.com", "john", []string{"john.doe@example.com"}, authentication.TwoFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=OPTIONS&title=Access+Denied&url=https%3A%2F%2Ftest.example.com"},
		...
		{"OPTIONS", "https://deny.example.com", "john", []string{"john.doe@example.com"}, authentication.TwoFactor, 302, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=OPTIONS&title=Access+Denied&url=https%3A%2F%2Fdeny.example.com"},
		...
		{"POST", "https://test.example.com", "john", []string{"john.doe@example.com"}, authentication.OneFactor, 303, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=POST&title=Access+Denied&url=https%3A%2F%2Ftest.example.com"},
		...
		{"POST", "https://deny.example.com", "john", []string{"john.doe@example.com"}, authentication.OneFactor, 303, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=POST&title=Access+Denied&url=https%3A%2F%2Fdeny.example.com"},
		{"POST", "https://test.example.com", "john", []string{"john.doe@example.com"}, authentication.TwoFactor, 303, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=POST&title=Access+Denied&url=https%3A%2F%2Ftest.example.com"},
		...
		{"POST", "https://deny.example.com", "john", []string{"john.doe@example.com"}, authentication.TwoFactor, 303, "https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=POST&title=Access+Denied&url=https%3A%2F%2Fdeny.example.com"},
	}
...
func TestGetRedirectionURL(t *testing.T) {
	testCases := []struct {
		...
		{"SimpleForbidden", "https://auth.example.com/", "GET", true, MustParseURL("https://app.example.com/?p=1&t=a"), MustParseURL("https://auth.example.com/error?code=403&description=Your+access+to+this+resource+is+forbidden&message=Forbidden&method=GET&title=Access+Denied&url=https%3A%2F%2Fapp.example.com%2F%3Fp%3D1%26t%3Da"), ""},
