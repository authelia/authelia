...
func handleOIDCAuthorizationConsent(ctx *middleware.AutheliaCtx, rootURI string, client *oidc.Client,
...
func handleOIDCAuthorizationConsentWithChallengeID(ctx *middleware.AutheliaCtx, rootURI string, client *oidc.Client,
...
func handleOIDCAuthorizationConsentOrGenerate(ctx *middleware.AutheliaCtx, rootURI string, client *oidc.Client,
	userSession session.UserSession, subject model.NullUUID,
	rw http.ResponseWriter, r *http.Request, requester fosite.AuthorizeRequester) (consent *model.OAuth2ConsentSession, handled bool) {
	var (
		err error
...
func handleOIDCAuthorizationConsentGenerate(ctx *middleware.AutheliaCtx, rootURI string, client *oidc.Client,
	userSession session.UserSession, subject model.NullUUID,
	rw http.ResponseWriter, r *http.Request, requester fosite.AuthorizeRequester) (consent *model.OAuth2ConsentSession, handled bool) {
	var err error
...
func handleOIDCAuthorizationConsentRedirect(ctx *middleware.AutheliaCtx, destination string, client *oidc.Client,
...
func getOIDCPreConfiguredConsentFromClientAndConsent(ctx *middleware.AutheliaCtx, client fosite.Client, consent *model.OAuth2ConsentSession) (preConfigConsent *model.OAuth2ConsentSession, err error) {
...
func getOIDCPreConfiguredConsent(ctx *middleware.AutheliaCtx, clientID string, subject uuid.UUID, scopes, audience []string) (consent *model.OAuth2ConsentSession, err error) {
	var (
