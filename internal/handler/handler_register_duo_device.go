...
func DuoDevicesGET(duoAPI duo.API) middleware.RequestHandler {
...
func DuoDevicePOST(ctx *middleware.AutheliaCtx) {
...
func SecondFactorDuoDeviceDelete(ctx *middleware.AutheliaCtx) {
	userSession := ctx.GetSession()
