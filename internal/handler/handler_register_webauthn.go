...
var WebauthnIdentityStart = middleware.IdentityVerificationStart(middleware.IdentityVerificationStartArgs{
...
var WebauthnIdentityFinish = middleware.IdentityVerificationFinish(
...
func SecondFactorWebauthnAttestationGET(ctx *middleware.AutheliaCtx, _ string) {
	var (
		w    *webauthn.WebAuthn
...
func WebauthnAttestationPOST(ctx *middleware.AutheliaCtx) {
	var (
		err  error
		w    *webauthn.WebAuthn
		user *model.WebauthnUser
