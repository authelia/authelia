...
type UserSessionMessagePack struct {
	...
	WebAuthn                   *session.WebAuthn     `json:"webauthn,omitempty"`
...
func (s *session.UserSession) ToMessagePack() (mp *UserSessionMessagePack) {
	if s == nil {
		return nil
	}
...
func (s *UserSessionMessagePack) ToUserSession() *session.UserSession {
	if s == nil {
		return nil
	}
...
func (w *session.WebAuthn) ToMessagePack() *WebAuthnMessagePack {
	if w == nil {
		return nil
	}
...
func (w *WebAuthnMessagePack) ToWebAuthn() *session.WebAuthn {
	if w == nil {
		return nil
	}

	return &session.WebAuthn{
...
func (t *session.TOTP) ToMessagePack() *TOTPMessagePack {
	if t == nil {
		return nil
	}
...
func (t *TOTPMessagePack) ToTOTP() *session.TOTP {
	if t == nil {
		return nil
	}
...
func (e session.Elevations) ToMessagePack() ElevationsMessagePack {
	return ElevationsMessagePack{
		User: e.User.ToMessagePack(),
	}
}

func (e ElevationsMessagePack) ToElevations() session.Elevations {
	return session.Elevations{
		User: e.User.ToElevation(),
	}
}

func (e *session.Elevation) ToMessagePack() *ElevationMessagePack {
	if e == nil {
		return nil
	}
...
func (e *ElevationMessagePack) ToElevation() *session.Elevation {
	if e == nil {
		return nil
	}
