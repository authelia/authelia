...
export const IdentityVerificationOTC = ({
	...
	return (
		<Html lang="en" dir="ltr">
			<Head />
			<Preview>A one-time code has been generated for session elevation</Preview>
			<Tailwind>
				<Body className="bg-white my-auto mx-auto font-sans px-2">
					<Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
						<Heading className="text-black text-[24px] font-normal text-center p-0 my-[30px] mx-0">
							A <strong>one-time code</strong> has been generated for session elevation
						</Heading>
						...
						<Text className="text-black text-[14px] leading-[24px]">
							This notification has been sent to you in order to elevate your session sufficiently to{" "}
							<strong>change security details</strong> for your account. <strong>Do not share this
							notification or the content of this notification with anyone.</strong> The following{" "}
							<i>one-time code</i> should be used in the prompt displayed in your browser.
						</Text>
						<Hr className="border border-solid border-[#eaeaea] my-[26px] mx-0 w-full"/>
						<Section>
							<Text id="one-time-code" className="text-black text-center tracking-[0.5rem] font-bold text-lg"
						...
						<Text className="text-[#666666] text-[12px] leading-[24px] text-center">
							...
							one-time code was generated due to an action from <span className="text-black">{remoteIP}</span>.
