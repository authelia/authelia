...
func TestOpenIDConnectProvider_NewOpenIDConnectProvider_GetOpenIDConnectWellKnownConfiguration(t *testing.T) {
	...
	assert.Len(t, disco.IDTokenSigningAlgValuesSupported, 6)
	assert.Contains(t, disco.IDTokenSigningAlgValuesSupported, SigningAlgorithmRSAWithSHA256)
	assert.Contains(t, disco.IDTokenSigningAlgValuesSupported, SigningAlgorithmRSAWithSHA384)
	assert.Contains(t, disco.IDTokenSigningAlgValuesSupported, SigningAlgorithmRSAWithSHA512)
	assert.Contains(t, disco.IDTokenSigningAlgValuesSupported, SigningAlgorithmRSAASAPSSWithSHA256)
	assert.Contains(t, disco.IDTokenSigningAlgValuesSupported, SigningAlgorithmRSAASAPSSWithSHA384)
	assert.Contains(t, disco.IDTokenSigningAlgValuesSupported, SigningAlgorithmRSAASAPSSWithSHA512)

	assert.Len(t, disco.UserinfoSigningAlgValuesSupported, 7)
	...
	assert.Contains(t, disco.UserinfoSigningAlgValuesSupported, SigningAlgorithmRSAWithSHA384)
	assert.Contains(t, disco.UserinfoSigningAlgValuesSupported, SigningAlgorithmRSAWithSHA512)
	assert.Contains(t, disco.UserinfoSigningAlgValuesSupported, SigningAlgorithmRSAASAPSSWithSHA256)
	assert.Contains(t, disco.UserinfoSigningAlgValuesSupported, SigningAlgorithmRSAASAPSSWithSHA384)
	assert.Contains(t, disco.UserinfoSigningAlgValuesSupported, SigningAlgorithmRSAASAPSSWithSHA512)
