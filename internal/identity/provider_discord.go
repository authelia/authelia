...
func (p *DiscordProvider) LogoURI() string {
	return p.logoURI
}
...
// SharedRedirectURI implements Provider. Discord does not send the 'iss' parameter the shared redirect URI requires.
func (p *DiscordProvider) SharedRedirectURI() bool {
	return false
}
