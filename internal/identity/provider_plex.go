...
func (p *PlexProvider) LogoURI() string {
	return p.logoURI
}
...
// SharedRedirectURI implements Provider. Plex does not send the 'iss' parameter the shared redirect URI requires.
func (p *PlexProvider) SharedRedirectURI() bool {
	return false
}
