	...
	attemptsInDB := []models.AuthenticationAttempt{
		{
			Username:   "john",
			Successful: true,
			Time:       models.Time{Time: s.clock.Now().Add(-4 * time.Minute)},
		},
	}

	s.storageMock.EXPECT().
		LoadAuthenticationAttempts(s.ctx, gomock.Eq("john"), gomock.Any(), gomock.Eq(10), gomock.Eq(0)).
	...
	attemptsInDB := []models.AuthenticationAttempt{
		{
			Username:   "john",
			Successful: false,
			Time:       models.Time{Time: s.clock.Now().Add(-1 * time.Second)},
		},
		{
			Username:   "john",
			Successful: false,
			Time:       models.Time{Time: s.clock.Now().Add(-90 * time.Second)},
		},
		{
			Username:   "john",
			Successful: false,
			Time:       models.Time{Time: s.clock.Now().Add(-180 * time.Second)},
		},
	}
...
func (s *RegulatorSuite) TestShouldBanUserIfLatestAttemptsAreWithinFinTime() {
	attemptsInDB := []models.AuthenticationAttempt{
		...
		},
		{
			Username:   "john",
			Successful: false,
			Time:       models.Time{Time: s.clock.Now().Add(-4 * time.Second)},
		},
		{
			Username:   "john",
			Successful: false,
			Time:       models.Time{Time: s.clock.Now().Add(-6 * time.Second)},
		},
		{
			Username:   "john",
			Successful: false,
	...
	attemptsInDB := []models.AuthenticationAttempt{
		{
			Username:   "john",
			Successful: false,
			Time:       models.Time{Time: s.clock.Now().Add(-31 * time.Second)},
		},
		{
			Username:   "john",
			Successful: false,
			Time:       models.Time{Time: s.clock.Now().Add(-34 * time.Second)},
		},
		{
			Username:   "john",
			Successful: false,
			Time:       models.Time{Time: s.clock.Now().Add(-36 * time.Second)},
		},
	}
	...
	attemptsInDB := []models.AuthenticationAttempt{
		{
			Username:   "john",
			Successful: false,
			Time:       models.Time{Time: s.clock.Now().Add(-14 * time.Second)},
		},
		...
		// of retrieved attempts is 3.
		{
			Username:   "john",
			Successful: false,
			Time:       models.Time{Time: s.clock.Now().Add(-94 * time.Second)},
		},
		{
			Username:   "john",
			Successful: false,
			Time:       models.Time{Time: s.clock.Now().Add(-96 * time.Second)},
		},
	}
...
func (s *RegulatorSuite) TestShouldCheckRegulationHasBeenResetOnSuccessfulAttempt() {
	attemptsInDB := []models.AuthenticationAttempt{
		...
		},
		{
			Username:   "john",
			Successful: true,
			Time:       models.Time{Time: s.clock.Now().Add(-93 * time.Second)},
		},
