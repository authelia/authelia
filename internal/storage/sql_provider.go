...
func (p *SQLProvider) CreateExistingUserMetadata(ctx context.Context, username string) (err error) {
	if _, err = p.conn(ctx).ExecContext(ctx, p.sqlInsertUserMetadata, username); err != nil {
...
func (p *SQLProvider) CreateNewUserMetadata(ctx context.Context, username string) (err error) {
	if _, err = p.conn(ctx).ExecContext(ctx, p.sqlInsertNewUserMetadata, username, time.Now()); err != nil {
...
func (p *SQLProvider) CreateExistingUserMetadataAtLogin(ctx context.Context, username string) (err error) {
	if _, err = p.conn(ctx).ExecContext(ctx, p.sqlInsertExistingUserAtLoginMetadata, username, time.Now()); err != nil {
		return fmt.Errorf("error creating new user Metadata for user '%s': %w", username, err)
	}
...
// CreateExistingUserMetadataAtPasswordChange adds an existing user's metadata record to the storage provider, and sets their last password change time.
func (p *SQLProvider) CreateExistingUserMetadataAtPasswordChange(ctx context.Context, username string) (err error) {
	if _, err = p.conn(ctx).ExecContext(ctx, p.sqlInsertExistingUserAtPasswordChangeMetadata, username, time.Now()); err != nil {
		return fmt.Errorf("error creating new user Metadata for user '%s': %w", username, err)
	}
...
func (p *SQLProvider) LoadAllUsersMetadata(ctx context.Context) (allUserMetadata []model.UserInfo, err error) {
	rows, err := p.conn(ctx).QueryContext(ctx, p.sqlSelectUserMetadata)
	if err != nil {
...
func (p *SQLProvider) LoadMultipleUsersMetadataByUsername(ctx context.Context, usernames []string) (allUserMetadata []model.UserInfo, err error) {
	query, args, err := sqlx.In(fmt.Sprintf(queryFmtSelectMultipleUserMetadataByUsername, tableUserMetadata), usernames)
	if err != nil {
		return nil, fmt.Errorf("error expanding user Metadata query: %w", err)
	}
...
func (p *SQLProvider) LoadUserMetadataByUsername(ctx context.Context, username string) (userMetadata model.UserInfo, err error) {
	...
	err = p.conn(ctx).QueryRowxContext(ctx, p.sqlSelectUserMetadataByUsername, username).Scan(
...
func (p *SQLProvider) UpdateUserSignInDateByUsername(ctx context.Context, username string) (err error) {
	result, err := p.conn(ctx).ExecContext(ctx, p.sqlUpdateUserRecordSignInByUsername, time.Now(), username)
	if err != nil {
...
func (p *SQLProvider) DeleteUserByUsername(ctx context.Context, username string) (err error) {
	if _, err = p.conn(ctx).ExecContext(ctx, p.sqlDeleteUserMetadataByUsername, username); err != nil {
...
func (p *SQLProvider) UpdatePasswordChangedDateByUsername(ctx context.Context, username string) (err error) {
	result, err := p.conn(ctx).ExecContext(ctx, p.sqlUpdateUserRecordPasswordChangedAtByUsername, time.Now(), username)
	if err != nil {
...
func (p *SQLProvider) LoadAllUserInfo(ctx context.Context) (info []model.UserInfo, err error) {
	rows, err := p.conn(ctx).QueryContext(ctx, p.sqlSelectAllUserInfo)
	if err != nil {
...
func (p *SQLProvider) LoadAllUserInfoAndMetadata(ctx context.Context) (info []model.UserInfo, err error) {
	rows, err := p.conn(ctx).QueryContext(ctx, p.sqlSelectAllUserInfoAndMetadata)
	if err != nil {
