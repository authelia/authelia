...
// DeletePreferredDuoDevice delete a Duo device and method of a given user.
func (p *SQLProvider) DeletePreferredDuoDevice(username string) error {
	_, err := p.db.Exec(p.sqlDeleteDuoDevice, username)
	return err
}
