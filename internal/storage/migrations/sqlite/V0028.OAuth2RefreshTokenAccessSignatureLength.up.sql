...
CREATE TABLE IF NOT EXISTS _bkp_UP_V0028_oauth2_refresh_token_session (
    ...
    access_signature VARCHAR(255) NOT NULL DEFAULT ''
);

INSERT INTO _bkp_UP_V0028_oauth2_refresh_token_session (challenge_id, request_id, client_id, signature, subject, requested_at, requested_scopes, granted_scopes, requested_audience, granted_audience, active, revoked, form_data, session_data, access_signature)
SELECT challenge_id, request_id, client_id, signature, subject, requested_at, requested_scopes, granted_scopes, requested_audience, granted_audience, active, revoked, form_data, session_data, access_signature
...
CREATE TABLE IF NOT EXISTS oauth2_refresh_token_session (
    ...
    form_data TEXT NOT NULL,
    session_data BLOB NOT NULL,
    access_signature VARCHAR(768) NOT NULL DEFAULT '',
...
INSERT INTO oauth2_refresh_token_session (challenge_id, request_id, client_id, signature, subject, requested_at, requested_scopes, granted_scopes, requested_audience, granted_audience, active, revoked, form_data, session_data, access_signature)
SELECT challenge_id, request_id, client_id, signature, subject, requested_at, requested_scopes, granted_scopes, requested_audience, granted_audience, active, revoked, form_data, session_data, access_signature
FROM _bkp_UP_V0028_oauth2_refresh_token_session
ORDER BY id;

DROP TABLE IF EXISTS _bkp_UP_V0028_oauth2_refresh_token_session;
