...
type Provider interface {
	...
	LoadOAuth2ConsentSessionBySignature(ctx context.Context, clientID string, subject uuid.UUID, scopes model.StringSlicePipeDelimited) (consent *model.OAuth2ConsentSession, err error)
