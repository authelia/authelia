...
type Provider interface {
	...
	SaveU2FDevice(ctx context.Context, device model.U2FDevice) (err error)
	LoadU2FDevice(ctx context.Context, username string) (device *model.U2FDevice, err error)
	LoadU2FDevices(ctx context.Context, limit, page int) (devices []model.U2FDevice, err error)
