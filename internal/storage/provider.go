...
type Provider interface {
	...
	*/
	...
	// LoadExternalIdentityLinksByUsername loads all external identity links for a user, including any link whose signature
	// is not valid, which is reported by the SignatureValid value of the link.
