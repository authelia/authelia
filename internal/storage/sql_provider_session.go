...
func (p *SQLProvider) sessionPublicIDMoved(ctx context.Context, issuer, id, pid string) (moved bool) {
	var signature string

	if err := p.db.GetContext(ctx, &signature, p.sqlSelectSessionSignatureByPublicID, issuer, pid); err != nil {
		return false
	}
