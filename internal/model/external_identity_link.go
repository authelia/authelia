...
type ExternalIdentityLink struct {
	...
	// SignatureValid reports whether the signature of the link was verified when it was loaded. It is never stored. A
	// link which was not verified must never be used for anything other than being displayed or deleted.
	SignatureValid bool `db:"-" json:"-"`
}
