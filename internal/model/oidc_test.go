	...
	testCases := []struct {
	...
	}{
		{
			...
			&model.OAuth2PARContext{
				...
				Session:              []byte(`{"id_token":null,"requested_at":0,"challenge_id":null,"kid":"","client_id":"","client_credentials":false,"exclude_nbf_claim":false,"allowed_top_level_claims":null,"extra":null}`),
			},
			"",
		},
		{
