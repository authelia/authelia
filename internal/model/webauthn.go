...
type WebAuthnCredentialData struct {
	...
	BackupState       bool       `yaml:"backup_state" toml:"backup_state" json:"backup_state" jsonschema:"title=Backup Eligible" jsonschema_description:"The backup state of this credential."`
