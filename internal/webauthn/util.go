...
func IsCredentialCreationDiscoverable(response *protocol.ParsedCredentialCreationData) (discoverable bool) {
	credProps := response.ClientExtensionResults.CredProps

	return credProps != nil && credProps.RK != nil && *credProps.RK
}
