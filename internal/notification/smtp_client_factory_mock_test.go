...
//
//	mockgen -write_package_comment=false -package notification -destination smtp_client_factory_mock_test.go -mock_names SMTPClientFactory=MockSMTPClientFactory github.com/authelia/authelia/v4/internal/notification SMTPClientFactory
//
