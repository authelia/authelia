...
//
//	mockgen -write_package_comment=false -package notification -destination smtp_client_mock_test.go -mock_names SMTPClient=MockSMTPClient github.com/authelia/authelia/v4/internal/notification SMTPClient
//
