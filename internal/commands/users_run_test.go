...
func newTestCmdCtx(t *testing.T) (ctx *CmdCtx, ctrl *gomock.Controller, userProvider *mocks.MockUserProvider, storageProvider *mocks.MockStorage) {
	t.Helper()
...
func TestUsersSchemaPrintRunE(t *testing.T) {
	ctx, ctrl, userProvider, _ := newTestCmdCtx(t)
	defer ctrl.Finish()
...
func TestUsersGetRunE(t *testing.T) {
	t.Run("ShouldReturnUserWithDefaultFields", func(t *testing.T) {
		ctx, ctrl, userProvider, storageProvider := newTestCmdCtx(t)
		defer ctrl.Finish()
	...
	t.Run("ShouldRejectJSONFormatWithFields", func(t *testing.T) {
		ctx, ctrl, _, storageProvider := newTestCmdCtx(t)
		defer ctrl.Finish()
